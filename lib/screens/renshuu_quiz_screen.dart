...
class RenshuuQuizScreen extends StatefulWidget {
  final String chapter;
  final List<RenshuuData> renshuuList;

  const RenshuuQuizScreen({super.key, required this.chapter, required this.renshuuList});

  @override
  State<RenshuuQuizScreen> createState() => _RenshuuQuizScreenState();
}

class _RenshuuQuizScreenState extends State<RenshuuQuizScreen> {
  final TextEditingController _answerController = TextEditingController();
  final FocusNode _focusNode = FocusNode();
  final FlutterTts flutterTts = FlutterTts(); 
  
  List<RenshuuData> _activeQueue = [];
  List<RenshuuData> _incorrectQueue = [];
  ...
  void initState() {
    super.initState();
    _activeQueue = List.from(widget.renshuuList);
    _initTts(); 
  }
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(widget.chapter, style: const TextStyle(fontSize: 20.0, fontWeight: FontWeight.w800, letterSpacing: -0.5)),
          centerTitle: true,
          bottom: _isStarting 
            ? null 
            : PreferredSize(
        ...
        Expanded(
          child: Padding(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                Icon(Icons.history_edu_rounded, size: 80.0, color: Theme.of(context).colorScheme.primary),
                ...
                const Text(
                  'Ready to practice sentence patterns?', 
                  textAlign: TextAlign.center, 
            ...
            Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: Theme.of(context).colorScheme.secondary.withOpacity(0.3), width: 1.0)
                ),
                child: Text(
